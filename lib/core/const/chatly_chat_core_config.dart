...
/// for rooms and users collections. Call [ChatlyChatCore.instance.setConfig]
/// before doing anything else with [ChatlyChatCore.instance] if you want to
/// change the default collection names. When using custom names don't forget
/// to update your security rules and indexes.
@immutable
class ChatlyChatCoreConfig {
  const ChatlyChatCoreConfig(
