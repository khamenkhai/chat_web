...
import 'package:chat_application/core/component/custom_error_widget.dart';
...
import 'package:chat_application/core/utils/format_last_seen.dart';
import 'package:chat_application/view/chat/chat_content.dart';
import 'package:chat_application/view/common/user_avatar.dart';
import 'package:chat_application/view/theme/theme_switch.dart';
...
final replyMessageProvider = StateProvider<fc.Message?>((ref) => null);
  ...
  Widget build(BuildContext context) {
    ...
    return Consumer(
      builder: (context, ref, _) {
        ...
        final fc.Room? room = ref.watch(selectedRoomProvider);

        if (room == null) {
          return FutureBuilder(
            future: fc.FyreChat.instance.getRoomById(roomId),
      ...
      appBar: AppBar(
        ...
        title: ListTile(
          ...
          subtitle: StreamBuilder(
            stream: fc.FyreChat.instance.getUserByIdStream(
              room.users
                  .firstWhere(
