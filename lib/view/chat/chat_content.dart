...
import 'package:chat_application/controller/chat_sound_player.dart';
...
import 'package:chat_application/view/chat/widgets/chat_components/edit_message_dialog.dart';
import 'package:chat_application/view/chat/widgets/message_bubble.dart';
import 'package:chat_application/view/chat/widgets/message_input.dart';
import 'package:chat_application/view/chat/widgets/chat_components/message_options_dialog.dart';
...
class ChatContentState extends State<ChatContent> {
  ...
  void _handleEditMessage(BuildContext context, fc.Message message) {
    if (message is fc.TextMessage) {
      showEditMessageDialog(
        ...
        onSave: (newText) {
          fc.FyreChat.instance.editTextMessage(
            roomId: widget.room.id,
  ...
  void _handleDeleteMessage(fc.Message message) {
    fc.FyreChat.instance.setDeleteMessage(
      roomId: widget.room.id,
      messageId: message.id,
    );
  }
