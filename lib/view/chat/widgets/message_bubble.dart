...
import 'package:chat_application/core/const/theme_const.dart';
import 'package:chat_application/core/utils/context_extension.dart';
import 'package:chat_application/view/chat/widgets/bubble_components/deleted_message_tile.dart';
import 'package:chat_application/view/chat/widgets/bubble_components/file_message_tile.dart';
import 'package:chat_application/view/chat/widgets/bubble_components/image_message_tile.dart';
import 'package:chat_application/view/common/user_avatar.dart';
...
class MessageBubble extends StatelessWidget {
    ...
    return Container(
      ...
      child: ReactionButton<String>(
        ...
        onReactionChanged: (Reaction<String>? reaction) {
          fc.FyreChat.instance.reactToMessage(
            roomId: roomId,
  ...
  Widget _buildOtherUserReaction() {
    return FutureBuilder<String?>(
      future: fc.FyreChat.instance.getOtherReaction(
        roomId: roomId,
        messageId: message.id,
  ...
  void _handleMessageTap(BuildContext context) {
    if (message is fc.FileMessage) {
      _downloadFile(message as fc.FileMessage, context);
    }
    onTap();
  }
  ...
  Widget _buildReplyWidget(ThemeData theme, fc.Message repliedMessage) {
    final messageColors = theme.extension<MessageColors>()!;
  ...
  Widget _buildReplyContent(fc.Message message, ThemeData theme) {
  ...
  Widget _buildMessageContent(ThemeData theme, BuildContext context) {
    if (message is fc.TextMessage) {
      ...
      return FileMessageTile(message: message as fc.FileMessage);
    }
    return Container(
  ...
  Widget _buildTextMessage(ThemeData theme) {
    return Container(
      ...
      child: Text(
        (message as fc.TextMessage).text,
