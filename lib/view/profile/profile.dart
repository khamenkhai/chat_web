...
import 'package:chat_application/controller/profile_provider.dart';
...
class _ProfileUpdatePageState extends ConsumerState<ProfileUpdatePage> {
  ...
  Widget _buildProfileForm(fc.User? user, profileState) {
    if (user == null) {
  ...
  Widget _buildProfilePicture(fc.User user) {
    return Center(
      child: Stack(
